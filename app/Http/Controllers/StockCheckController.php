...
class StockCheckController extends Controller
{
    public function index()
    {
        ...
        return view('stockCheck.index', \compact('products', 'inStocks', 'count_inC', 'count_c', 'inComplete', 'completed'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $stock->save();
        return redirect()->route('stock-check')->with('success', 'Successfully Created!');
    }
