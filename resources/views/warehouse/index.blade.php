...
@section('page-content')
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Warehouse Lists</h3>
        </div>
        ...
        @can('purchase-create')
            <button type="button" id="demo-custom-toolbar2" class="btn btn-pink table-toolbar-left" data-toggle="modal" data-target="#ModalExample">
                <i class="fa fa-save fa-fw"></i> Wrehouse Add
            </button>
        @endcan

        <div class="panel-body">
            <form class="form-inline" action="{{ route('warehouse-search') }}" method="GET">
                <div class="col-md-3">
                    ...
                    <tr>
                        ...
                        @endcan
                            <td>
                                @can('purchase-delete')
                                    <div class="col-md-3">
                                        <form action="{{ route('warehouse-delete', $value->id)}}" method="post">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-xs-center">Add Warehouse</h4>
                </div>
